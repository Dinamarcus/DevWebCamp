<footer class="footer">
    ...
    <p class="footer__texto">DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva a cabo de forma presencial y en linea.</p>
    
    <p class="footer__copyright"><span class="footer__copyright--span">DevWebCamp</span> - Todos los derechos reservados <?php echo date('Y'); ?></p>
</footer>